        ...
        for j = 20:20:180
            for i = 0:20:1420
                   ...
                   elseif j-mo>=1 && j+mo<=ydim && i-mo<1
                      ...
                      vv_tmp = [vv_re((xdim+i-mo):xdim,j-mo:j+mo);vv_re(1:(i+mo),j-mo:j+mo)];
                   elseif j-mo>=1 && j+mo<=ydim && i+mo>xdim
                      ...
                      vv_tmp = [vv_re((i-mo):xdim,j-mo:j+mo);vv_re(1:(i+mo-xdim),j-mo:j+mo)];
                   else
                      ...
                      vv_tmp = squeeze(vv_re(i-mo:i+mo,j-mo:j+mo));
                   end
            ...
            cell_vv(end+1,:) = {m_vv,m_vv_mcs,m_vv_nonmcs,m_vv_nonmcs_pr2,m_vv_nonmcs_dry2,m_vv_mcs_pr2,m_vv_mcs_dry2,hr};
            end
        end
    end
    save(['/neelin2020/ACRE/Processed/MCS_std_ceres_vv_10x10rc_' yyyy mm dd '_every5_new.mat'],'cell_vv');
    clear cell_vv;
end
end
end
