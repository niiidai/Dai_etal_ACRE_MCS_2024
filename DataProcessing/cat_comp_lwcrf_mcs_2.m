...
save(['/neelin2020/ACRE/Processed_ACRE_revised/lwcrf_mcs_' num2str(k) '0x' num2str(k) '0_new_2.mat'],'lwcrf_mcs');
save(['/neelin2020/ACRE/Processed_ACRE_revised/lwcrf_nonmcs_' num2str(k) '0x' num2str(k) '0_new_2.mat'],'lwcrf_nonmcs');
save(['/neelin2020/ACRE/Processed_ACRE_revised/lwcrf_nonmcs_pr2_' num2str(k) '0x' num2str(k) '0_new_2.mat'],'lwcrf_nonmcs_pr2');
save(['/neelin2020/ACRE/Processed_ACRE_revised/lwcrf_nonmcs_dry2_' num2str(k) '0x' num2str(k) '0_new_2.mat'],'lwcrf_nonmcs_dry2');
save(['/neelin2020/ACRE/Processed_ACRE_revised/lwcrf_mcs_pr2_' num2str(k) '0x' num2str(k) '0_new_2.mat'],'lwcrf_mcs_pr2');
save(['/neelin2020/ACRE/Processed_ACRE_revised/lwcrf_mcs_dry2_' num2str(k) '0x' num2str(k) '0_new_2.mat'],'lwcrf_mcs_dry2');
end
