...
save(['/neelin2020/ACRE/Processed_ACRE_revised/vv_mcs_' num2str(k) '0x' num2str(k) '0_new_1.mat'],'vv_mcs');
save(['/neelin2020/ACRE/Processed_ACRE_revised/vv_nonmcs_' num2str(k) '0x' num2str(k) '0_new_1.mat'],'vv_nonmcs');
save(['/neelin2020/ACRE/Processed_ACRE_revised/vv_nonmcs_pr2_' num2str(k) '0x' num2str(k) '0_new_1.mat'],'vv_nonmcs_pr2');
save(['/neelin2020/ACRE/Processed_ACRE_revised/vv_nonmcs_dry2_' num2str(k) '0x' num2str(k) '0_new_1.mat'],'vv_nonmcs_dry2');
save(['/neelin2020/ACRE/Processed_ACRE_revised/vv_mcs_pr2_' num2str(k) '0x' num2str(k) '0_new_1.mat'],'vv_mcs_pr2');
save(['/neelin2020/ACRE/Processed_ACRE_revised/vv_mcs_dry2_' num2str(k) '0x' num2str(k) '0_new_1.mat'],'vv_mcs_dry2');
end
